...
import type { Map, MapOptions, LngLatLike, StyleSpecification } from 'maplibre-gl'
...
// Route visualization
export function addRouteLayer(map: Map, routeId: string) {
  // Add route source
...
export function addRevierLayer(map: Map, revierId: string) {
